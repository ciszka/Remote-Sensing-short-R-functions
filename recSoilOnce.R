#THis creates a soil mask after calculating an NDVI file
#this first calculates NDVI for thegiven raster file and 
#Based on empirical testing relcasses the soil values
#based on information from http://profhorn.meteor.wisc.edu/wxwise/satmet/lesson3/ndvi.html
...
recSoilOnce = function(scene, j, k){
  ...
  #creates a raster brick set of the file
  img = brick(scene) 
  ...
  # lead into the NDVI clasification by set up to vectors with information from
  #Different bands from the given scene
  bj = img[[j]] #Sets the ReNd band to this parameter
